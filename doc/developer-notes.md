...
Sgpr Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadRPCServer : Remote procedure call handler, listens on port 19610 for connections and services them.
...
However, in open source software such as Sgpr Core, where everyone uses
...
pay attention to for reviewers of Sgpr Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Sgpr Core uses tinyformat, which is type safe. Leave them out to avoid confusion
