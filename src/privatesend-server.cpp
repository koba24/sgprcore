...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Sgpr related functionality
...
/*
    ...
    allow endless transaction that would bloat Sgpr and make it unusable. To
