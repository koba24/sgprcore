 ...
 *
 *   // network
 *   CSgprNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.sgprcoin.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSgprNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SgprNetwork
// //   -- signature requirements : Key1(User)
// class CSgprNetworkVariable : public CGovernanceObject
// {
// private:
