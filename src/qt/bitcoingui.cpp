    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Sgpr Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sgpr address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sgpr: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Sgpr Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sgpr Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sgpr Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sgpr addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sgpr addresses"));
    ...
    openAction->setStatusTip(tr("Open a sgpr: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sgpr Core help message to get a list with possible Sgpr Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Sgpr Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sgpr network", "", count));
    } else {
...
{
    QString strTitle = tr("Sgpr Core"); // default title
